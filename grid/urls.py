...
urlpatterns = [
    ...
    path('farm_details/<int:pk>/', farm_details_views, name='farm_details'),
    ...
    path('Update_user/<int:pk>/', admin_users_update_view, name='Update_user'),
